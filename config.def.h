 ...
 */
static char *font = "Iosevka SS07:size=13:antialias=true:autohint=true";

/* Spare fonts */
static char *font2[] = {
	"Iosevka Nerd Font:style=regular:size=13:antialias=true:autohint=true",
	"PowerlineSymbols:pixelsize=13:antialias=true"
};
